...
**Possible Entities:** 
- Plot: site(s) and location(s) contained within boundaries, time stamp, land attributes (snow-, water-, land-, total cover)
- Location: sites and plots contained within boundaries.
- Site: 
- Observer: employment period(s), sites they surveyed
...
CREATE TABLE Camp_assignment (
    ...
    Plot TEXT NOT NULL,
    FOREIGN KEY(Plot) REFERENCES Color_band_code (Color),
